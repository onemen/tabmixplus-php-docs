    ...
    <div class="menu-body">
      <div class="topic changelog">
        <h4><u>Versions 0.5.0.0+</u></h4>

<?php
  $href = "viewpage.php?t=1&p";
  $target = 'target="tabmix-changelog-content"';
echo <<<html
        <p><a href="$href=0.5.0.5" $target>0.5.0.5 - <span style="font-size: 0.9em;">Development version</span></a></p>
        <p><a href="$href=0.5.0.4" $target>0.5.0.4 - <span style="font-size: 0.9em;">Current version</span></a></p>
        <p><a href="$href=0.5.0.3" $target>0.5.0.3</a></p>
